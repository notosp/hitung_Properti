...
//var rumus = (Penghasilan-Pengeluaran) * jangkaWaktu * 12 / 3;
//println (rumus);
if (Penghasilan != '') {
    WebUI.setText(findTestObject('Object Repository/Page_Hitung Harga Properti Maksimal  BTN Pr_37bba6/input_Penghasilan'), 
        Penghasilan)
}
